...
\begin{document}
\title{ChemmineR-V2: Cheminformatics of Small Molecule Data}
...
The following allows to split SD Files into any number of smaller SD Files. This can become important when working with very big SD Files. \\
